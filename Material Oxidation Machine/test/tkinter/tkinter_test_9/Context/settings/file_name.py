...
#import confirm_file as cf
#from Context.settings.confirm_file import check_fileindata as cf
from . import confirm_file as cf
...
def my_file_name(window, year, month, day):
    ...
    if my_year == False or my_month == False or my_day == False:
        ...
        #cf(window, carta)
        cf.check_fileindata(window, carta)
