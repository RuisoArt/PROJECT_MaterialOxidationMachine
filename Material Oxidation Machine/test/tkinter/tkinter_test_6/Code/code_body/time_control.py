...
def body_control_time(window):
    ...
    parraf = Label(window
                   ,text="A continuación, deberá ingresar el tiempo\n"
                        +"que quiere mantener encendida y funcionando\n"
                        +"la Maquina de Niebla Salina.\n"
                        +"\n"
                        +"Debe ingresar la hora y el minuto (24h) en \n"
                        +"que quiere que la maquina se apague, sin \n"
                        +"embargo, puede en el TABLERO DE CONTROL \n"
                        +"PRINCIPAL apagar o encender luminarias o \n"
                        +"accionadores de potencia durante el proceso.\n"
                        +"\n"
                        +"Recuerde que el registro de los sensores se\n" 
                        +"da una vez es iniciado este software de \n"
                        +"lanzamiento y no durante el encendido de la \n"
                        +"computadora de la Maquina de Niebla salina.\n"    
