...
def body_textzone_date(window):
    ...
    verify_variables = Button(window, text=" VERIFICAR DATOS ", font="Helvetica 12", bg="#2ECC71", fg="white", width="20",
                       command= lambda: file_name.my_file_name(window, input_year, input_month, input_day))

    tittle.grid          (row=3, column=0,  columnspan=9) #hasta columna 7
    subtitle.grid        (row=4, column=0,  columnspan=9) 
    text_1.grid          (row=5, column=0,  columnspan=9)
    input_year.grid      (row=6, column=0,  columnspan=9)
    text_2.grid          (row=7, column=0,  columnspan=9)
    input_month.grid     (row=8, column=0,  columnspan=9)
    text_3.grid          (row=9, column=0,  columnspan=9)
    text_4.grid          (row=10, column=0, columnspan=9)
    text_5.grid          (row=11, column=0, columnspan=9)
    input_day.grid       (row=12, column=0, columnspan=9)
    verify_variables.grid(row=13, column=0, columnspan=9)
